...
{
    public class MetadataInjector : TagHelperComponent
    {
        ...
        {
            string manifestUrl = MetadataHandler.GetAppMetadata().ApplicatioManifestUrl.ToString();
        ...
        {
            string appTitle = MetadataHandler.GetOpenGraphDefaultData().Title.ToString();
        ...
        public static string GenerateApplicationMetaTags()
        {
            ...
            var applicationMetadata = MetadataHandler.GetAppMetadata();
            metaString.Append(
        ...
        {
            StringBuilder metaString = new();
            var appleIcons = MetadataHandler.GetAppleIcons();
        ...
        {
            StringBuilder metaString = new ();
            var androidIcons = MetadataHandler.GetFavicons();
        ...
        {
            StringBuilder metaString = new ();
            var openGraphDefaultData = MetadataHandler.GetOpenGraphDefaultData();
            metaString.Append(
        ...
        {
            StringBuilder metaString = new ();
            var openGraphTwitterData = MetadataHandler.GetOpenGraphTwitterData();
            metaString.Append(
